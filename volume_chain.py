...
class VolumeTree:
    ...
    def buildTree(self,root,ID,Name,Type,cinder_client):
        ...
        if root.Type == 'Volume':
            ...
            for snapshot_id in snapshot_list:
                ...
                root.dependency.append(Node(snapshot_id,snapshot_name,'Snapshot'))
        ...
        for value in root.dependency:
            self.buildTree(value,value.ID,value.Name,value.Type,cinder_client)
        return root
    ...
    def displayTree(self,root):
        ...
        while q.empty() is False:
            ...
            print
#
# Accept source volume id from the user. Build the tree. Display the dependencies.
#
def main():
    ...
    vol_tree.root = vol_tree.buildTree(vol_tree.root,args.volume_id,source_volume_name,'Volume',cc)
